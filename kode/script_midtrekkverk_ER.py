...
myGdf.to_file(  'ekstratall.gpkg', layer='midtrekkverk', driver='GPKG'  )
...
skrivdataframe.skrivdf2xlsx( [telling2,             telling,               lengde], '../../output/Ekstrarapport Midtrekkverk to og trefelts riksveg.xlsx', 
                sheet_name=['Midtrekkverk 2-3felt', 'Alle midtrekkverk', 'Midtrekkverk per vegnummer'], metadata=mittfilter)

tidsbruk = datetime.now() - t0 

print( 'Lengde midtrekkverk', round( myGdf['segmentlengde'].sum() / 1000 ), 'km, hvorav', round( myGdf[ myGdf['kjfelt'] == '2-3felt']['segmentlengde
    ...: '].sum()/1000 ), 'km er 2 eller 3 felts veg'  )
# Lengde midtrekkverk 1183 km, hvorav 261 km er 2 eller 3 felts veg